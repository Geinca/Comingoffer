...
$categories = $conn->query("SELECT * FROM categories WHERE shop_id = {$product['shop_id']}");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt = $conn->prepare("UPDATE products SET shop_id=?, category_id=?, product_name=?, description=?, price=?, image=? WHERE product_id=?");
  $stmt->bind_param("iissdsi", $shop_id, $category_id, $name, $desc, $price, $image, $id);
  $stmt->execute();
...
<body>
  ...
  <div class="container py-4">
    <div class="edit-header">
      <h3><i class="fas fa-edit me-2"></i> Edit Product: <?= htmlspecialchars($product['product_name']) ?></h3>
    </div>
      ...
      <form method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group-icon">
              ...
              <select name="shop_id" id="shop_id" class="form-select" required>
                <?php while ($s = $shops->fetch_assoc()): ?>
                  <option value="<?= htmlspecialchars($s['shop_id']) ?>" <?= ($s['shop_id'] == $product['shop_id']) ? 'selected' : '' ?>>
            ...
            <div class="input-group-icon">
              ...
              <select name="category_id" id="category_id" class="form-select">
                ...
                <?php while ($c = $categories->fetch_assoc()): ?>
                  <option value="<?= htmlspecialchars($c['category_id']) ?>" <?= ($c['category_id'] == $product['category_id']) ? 'selected' : '' ?>>
        ...
        <div class="mb-4">
          ...
          <?php if (!empty($product['image'])): ?>
            <p class="form-note">Current Image:</p>
            <img src="../uploads/product_images/<?= htmlspecialchars($product['image']) ?>" class="current-image" alt="Current Product Image">
          <?php endif; ?>
